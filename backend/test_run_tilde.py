...
from lib.bi_helper import bi_login, run_bi_sql_in_session, get_bip_PublicReportService_url
...
def main():
    ...
    dyn_report_path = f"/~{username}/QuickConfigTool/Dynamic SQL Executor CSV Report.xdo"
    dyn_template = "blank_en_US"
    
    print("\nRunning report via tilde path...")
